...
5. If an Ally makes an Ally identifiable to a non-Ally, even probabilistically, the Allies will ban them. Examples:
...
Admission is conditioned by a non-standardized test for which you cannot prepare.
